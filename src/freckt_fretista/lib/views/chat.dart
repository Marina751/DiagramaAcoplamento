...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key key, @required this.clienteId, @required this.peerAvatar})
      : super(key: key);

  @override
  State createState() =>
      ChatScreenState(clienteId: clienteId, peerAvatar: peerAvatar);
}

class ChatScreenState extends State<ChatScreen> {
  ChatScreenState(
      {Key key, @required this.clienteId, @required this.peerAvatar});
  ...
  readLocal() async {
    ...
    if (id.hashCode <= clienteId.hashCode) {
      groupChatId = '$id-$clienteId';
    } else {
      groupChatId = '$clienteId-$id';
    }
